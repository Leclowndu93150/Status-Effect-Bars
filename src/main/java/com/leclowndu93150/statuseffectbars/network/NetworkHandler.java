package com.leclowndu93150.statuseffectbars.network;

import com.leclowndu93150.statuseffectbars.StatusEffectBars;
...
public class NetworkHandler {
    ...
    public static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(
            new ResourceLocation(StatusEffectBars.MODID, "main"),
            () -> PROTOCOL_VERSION,
